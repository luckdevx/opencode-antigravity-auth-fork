# Antigravity Auth Plugin for Opencode — Fork with Model Filtering

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Fork](https://img.shields.io/badge/Fork-of%20NoeFabris%2Fopencode--antigravity--auth-blue.svg)](https://github.com/NoeFabris/opencode-antigravity-auth)

> **Fork of [NoeFabris/opencode-antigravity-auth](https://github.com/NoeFabris/opencode-antigravity-auth)** with model availability filtering, new model support (Gemini 3.5 Flash, GPT-OSS 120B), and quota display grouped by family.
...
The original plugin shows **all** models from a hardcoded manifest — including deprecated ones like `gemini-3-pro` that no longer work. This fork adds a configurable `hidden_models` option in `antigravity.json`:
...
## What You Get (inherited from upstream)
...
**This fork is loaded from a local path (not npm).**
